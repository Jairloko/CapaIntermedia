  ...
  <main>
    <div class="container w-75 pb-5 pt-0">
      <div class="row bg-light mb-4 pt-2 shadow">
        <p class="fs-4 ms-3 mb-3 fw-semibold ">Ventas</p>
        <div class="row row-cols-1 row-cols-lg-4 mb-2 mx-auto">
          ...
          <div class="col text-center" >      
            <p class="d-flex align-items-center ">Consulta
              <select name="tipoCon" id="tipoCon" class="form-select ms-1" onChange="Consulta()">
                <option selected value="detallada">Detallada</option>
      ...
      <!-- Ventas-->
      <div class="row bg-light shadow" id="ventas">
        <?php
          $var = new API_User;
          $var->LoadVentasUser($_SESSION['user']);
        ?>
