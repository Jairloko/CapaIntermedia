  ...
  <main>
    <div class="container-fluid pb-5 mb-5 ">
      <div class="row " id="content">
        <!--Otros datos-->
        <div class="col-lg-8 bg-light mx-lg-auto mt-lg-0 shadow px-5 " id="colListas">
          <div class="row border-bottom my-4">
            <div class="col text-center">
              <h2 class="">Carrito</h2>
            </div>
            <div class="col text-center">
              <a role="button" class="btn" href="Main.php">Agregar productos</a>
            </div>
            <div class="col text-center">
              <button class="btn" onClick="AgregarComentario('Algo')">Agregar Comentarios</button>
            </div>
          </div>

          <div id="prodLista">
            <?php 
            $prodCar = new API_Prod;
            $prodCar->LoadCarrito($_SESSION['user']);
            ?>
          </div>
